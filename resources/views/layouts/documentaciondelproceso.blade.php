    ...
    <main class="main-content">
        <div class="head-content">
            ...
            <div class="history">
                ...
                <a class="view" href="{{ url('/perfil') }}">Documentacion</a>
            </div>
            <div class="main-content">
                ...
                <div class="main-center">
                    ...
                    <i class="fi fi-rr-file-word">Elaboracion-del-informe-busqueda-de-informacion.pptx</i>
                </div>
                <div class="main-center">
                    <h2><strong>Articulo Bibliografico</strong></h2>
                    <h4>Presentacion sobre como crear el informe de busqueda de informacion del tema.</h4>
                    <i class="fi fi-br-file-pdf">Partes-de-un-articulo-bibliografco.pptx</i>
                </div>
            </div>
        </div>
    </main>
