document.addEventListener('DOMContentLoaded', function () {
    ...
    var titleInputEdit = document.getElementById('titleInputEdit')
    ...
    function handleListbox(listbox) {
        ...
        optionsList.addEventListener('click', function (event) {
            if (event.target.tagName === 'LI') {
                ...
                } else if (listbox.classList.contains('title')) {
                    titleInput.value = selectedOptionSpan.textContent
                ...
                } else if (listbox.classList.contains('title-edit')) {
                    titleInputEdit.value = selectedOptionSpan.textContent
                }
        
                if (selectedOption.trim() === 'Docente' ||
                    listbox.classList.contains('contract') ||
                    listbox.classList.contains('specialty') ||
                    listbox.classList.contains('title')) 
                {
                    document.querySelector('.lst-contract').removeAttribute('hidden')
                    document.querySelector('.lst-specialty').removeAttribute('hidden')
                    document.querySelector('.lst-title').removeAttribute('hidden')
                    document.querySelector('#idcQuantity').removeAttribute('hidden')
                } else {
                    ...
                    document.querySelector('.lst-title').setAttribute('hidden', 'false')
                    document.querySelector('#idcQuantity').setAttribute('hidden', 'false')
                }
    ...
    formAddUser.addEventListener('submit', function (event) {
        ...
        if (roleSpan === 'Docente') {
            ...
            const title = document.getElementById('title').getAttribute('data-value').trim()
    ...
    buttons.forEach(function (button) {
        button.addEventListener('click', function () {
            ...
            const idcQuantity = button.getAttribute('data-idcQuantity')
            ...
            const titleSpanEdit = document.getElementById('titleSpanEdit')
            const roleInpurEdit = document.getElementById('roleInputEdit')
            const idcQuantityEdit = document.getElementById('idcQuantityEdit')

            userIdInput.value = userId
            nameInput.value = userName
            emailInput.value = userEmail
            IdInput.value = userId
            roleInpurEdit.value = userRole
            ...
            if (userRole === 'Docente') {
                ...
                document.querySelector('.lst-title-edit').removeAttribute('hidden')
                idcQuantityEdit.removeAttribute('hidden')
                ...
                titleSpanEdit.innerText = title
                idcQuantityEdit.value = idcQuantity
                ...
                document.querySelector('.lst-title-edit').setAttribute('hidden', 'false')
                idcQuantityEdit.setAttribute('hidden', 'false')
            }
